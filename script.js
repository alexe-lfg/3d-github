    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if ('lose' in obj) {
                ...
                $("#buttonStartMines").show();
                $("#buttonStartMinesMobile").show();
                //$(that).addClass("mines-sq-danger").removeClass("mines-sq");
            }
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if ('success' in obj) {
                ...
                Cookies.set('hid', obj.success.hid, {
                    path: '/',
                    secure: true
                });
...
function getMinesRateMobile() {
    ...
    $(".js-range-slider").data("ionRangeSlider").update({
        from: $("#countBombMobile").prop("value")
    });
